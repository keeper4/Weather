...
extension UINavigationController {
    ...
    class func searchNavigationController() -> BaseNavigationController {
        let navigationController = SearchNavigationController(
            navigationBarClass: SearchNavigationNavigationBar.self, toolbarClass: nil)
...
class SearchNavigationNavigationBar: UINavigationBar {
    ...
    private func commonInit() {
        ...
        self.titleTextAttributes = [.font : UIFont.bold(size: 18), .foregroundColor : UIColor.white]
