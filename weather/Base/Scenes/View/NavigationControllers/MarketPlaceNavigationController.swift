//
//  MarketPlaceNavigationController.swift
//  Manzanita
//
//  Created by Oleksandr Chyzh on 08.07.2022.
...
extension UINavigationController {
    ...
    class func marketPlaceNavigationController() -> BaseNavigationController {
        let navigationController = MarketPlaceNavigationController(
            navigationBarClass: MarketPlaceNavigationBar.self, toolbarClass: nil)
        navigationController.modalPresentationStyle = .fullScreen
        return navigationController
    }
}

class MarketPlaceNavigationController: BaseNavigationController {
...
class MarketPlaceNavigationBar: UINavigationBar {
