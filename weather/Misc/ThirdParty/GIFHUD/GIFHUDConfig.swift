...
public struct GIFHUDConfig {
    ...
    /**
     ...
     - Default: 110.0
     */
    public var width: CGFloat = UIScreen.main.bounds.width / 3
    ...
    /**
     ...
     - Default: 110.0
     */
    public var height: CGFloat = UIScreen.main.bounds.width / 3
    ...
    /**
     ...
     - Default: .white
     */
    public var hudColor: UIColor = .clear
     ...
     */
    public var backgroundColor: UIColor = UIColor.blue_link
    ...
    /**
     ...
     - Default: 15
     */
    public var hudYOffset: CGFloat = 0
